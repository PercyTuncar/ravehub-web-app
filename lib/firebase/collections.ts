...
export const topDjsCyclesCollection = new FirestoreCollection<import('@/lib/types').TopDjsCycle>('topDjsCycles');
export const topDjsCandidatesCollection = new FirestoreCollection<import('@/lib/types').TopDjsCandidate>('topDjsCandidates');
export const topDjsNominationsCollection = new FirestoreCollection('topDjsNominations');
export const topDjsBallotsCollection = new FirestoreCollection<import('@/lib/types').TopDjsBallot>('topDjsBallots');
