...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return generateMetadataForCountry('EC', events) || {
    title: 'Eventos de Música Electrónica en Ecuador | Ravehub',
    description: 'Descubre eventos de música electrónica en Ecuador'
  }
}

export default async function EcuadorPage() {
  const events = await getEcuadorEvents()
  const schemaGenerator = new CountrySchemaGenerator('EC')
  const jsonLd = schemaGenerator.generateCountryPageSchema(events)
  const seoContent = generateSEOContent('EC', events)
    ...
    <main className="min-h-screen bg-black">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <video autoPlay loop muted playsInline className="absolute inset-0 w-full h-full object-cover z-0" preload="auto">
          <source src="/videos/ecuador-hero-bg.mp4" type="video/mp4" />
        </video>
            ...
            <div className="row-span-2 flex items-center justify-center">
              <div className="text-center space-y-4">
                <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight">
                  ...
                  <div className="text-yellow-500 text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold">Ecuador</div>
                </h1>
              </div>
            </div>
          ...
          <section className="py-20 px-4">
            <div className="max-w-4xl mx-auto">
              <div className="text-center mb-16">
                <h2 className="text-4xl md:text-5xl font-bold mb-6 bg-gradient-to-r from-yellow-400 to-blue-600 bg-clip-text text-transparent">
                  Música Electrónica en Todo Ecuador
                </h2>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                <div className="text-center group">
                  <div className="bg-gradient-to-br from-yellow-500/20 to-blue-600/10 rounded-3xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-500 hover:scale-105">
                    ...
                    <div className="text-sm text-gray-400 mt-2">En todo Ecuador</div>
                  </div>
                </div>
                <div className="text-center group">
                  <div className="bg-gradient-to-br from-yellow-500/20 to-blue-600/10 rounded-3xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-500 hover:scale-105">
                    ...
                    <div className="text-sm text-gray-400 mt-2">Quito, Guayaquil y más</div>
                  </div>
                </div>
                <div className="text-center group">
                  <div className="bg-gradient-to-br from-yellow-500/20 to-blue-600/10 rounded-3xl p-8 border border-yellow-500/20 hover:border-yellow-500/40 transition-all duration-500 hover:scale-105">
      ...
      <section id="eventos" className="py-20 px-4 bg-gradient-to-b from-yellow-950/30 via-black to-blue-950/30">
          ...
          {upcomingEvents.length === 0 ? (
            <div className="text-center py-16">
              <div className="bg-gray-900/50 rounded-3xl p-12 border border-gray-700/50">
                ...
                <p className="text-gray-500">Mantente atento a las novedades de música electrónica en Ecuador</p>
              </div>
            </div>
          ) : (
            <>
                  ...
                  <Card key={event.id} className="group overflow-hidden bg-gray-900/50 border-gray-700/50 hover:border-yellow-500/50 transition-all duration-500">
                    <div className="relative h-48 overflow-hidden">
                      <Image
                        ...
                        alt={`${event.name} - Evento de música electrónica en ${event.location.city}, Ecuador`}
                        fill
                    ...
                    <CardContent className="p-6">
                      ...
                      <Link href={`/eventos/${event.slug}`} className="block">
                        <Button className="w-full bg-gradient-to-r from-yellow-600 to-blue-600 hover:from-yellow-500 hover:to-blue-500 text-white font-semibold rounded-lg transition-all duration-300 transform hover:scale-105 shadow-lg">
      ...
      <CountryAbout data={COUNTRY_ABOUT.EC} />

      <CountryFAQ countryName="Ecuador" faqs={COUNTRY_FAQS.EC} />
    </main>
  )
}
