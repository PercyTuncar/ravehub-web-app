...
const GROUPS: WhatsAppGroup[] = [
  ...
  },
  {
    ...
    flag: "💜",
    name: "BTS 2026 🇵🇪",
    url: "https://chat.whatsapp.com/JY5rMMGp2n3HEHqxJZTam9",
  },
  {
    id: "girls",
    country: "Global",
                ...
                >
                  ...
                  <div className="relative flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      <h3 className="font-bold text-white text-base group-hover:text-[#25D366] transition-colors truncate">
                        {group.name}
                      </h3>
                      {group.isHot && (
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <svg
                  ...
                  className="relative w-6 h-6 text-pink-500 group-hover:text-pink-400"
                >
                  <rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect>
                  <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path>
                  <line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line>
                </svg>
                <span className="relative font-bold text-white text-sm">
                  Instagram
                </span>
              </motion.a>
              <motion.a
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(39,39,42,0.4) 0%, rgba(0,0,0,0.4) 100%)",
                }}
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                onClick={() =>
              ...
              >
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="relative w-6 h-6 text-cyan-400 group-hover:text-cyan-300"
                >
