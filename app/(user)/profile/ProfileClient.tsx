  ...
  return (
    <>
      <VerificationRequiredModal
        ...
        message="Para acceder a tu perfil completo y gestionar tus entradas, necesitas verificar tu correo electrónico."
      />
                ...
                <div className="flex flex-col items-center text-center">
                  ...
                  <div className="w-full mt-4">
                    <Button
                      ...
                      className="w-full text-white/50 hover:text-white hover:bg-white/5 group-hover:text-primary transition-colors"
                    >
