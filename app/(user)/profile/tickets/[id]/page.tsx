                                    ...
                                    {ticket.paymentMethod === 'offline' && ticket.paymentStatus === 'pending' && !isFullyPaid ? (
                                        ...
                                        <div className="p-4 backdrop-blur-md bg-red-500/10 border border-red-400/30 rounded-lg">
                                                    ...
                                                    return (
                                                        <div className="bg-orange-500/20 backdrop-blur-sm border border-orange-400/30 rounded-lg p-3 mb-4">
                                                            <p className="text-orange-300 text-sm">
                                                                Tienes <span className="font-bold">{hoursRemaining}h</span> para corregir tu pago.
                                                            </p>
                                                        </div>
                                                    );
                                                } else {
                                                    return (
                                                        <div className="bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 rounded-lg p-3 mb-4">
                                                            <p className="text-zinc-300 text-sm">
                                                                El tiempo para corregir el pago ha expirado.
                                                            </p>
                                                        </div>
                                                    );
                                                }
                                            ...
                                            <div className="space-y-2">
                                                {/* Opción 1: Pagar con Tarjeta (Solo si es pago online) */}
                                                {ticket.paymentMethod === 'online' && (
                                                    <Button
                                                        className="w-full bg-[#FBA905] hover:bg-[#FBA905]/90 text-black font-bold"
                                                ...
                                                {/* Opción 2: Enviar Comprobante por WhatsApp */}
                                                <Button
                                                    variant="outline"
