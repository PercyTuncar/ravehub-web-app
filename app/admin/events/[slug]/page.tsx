...
import { ArrowLeft, Edit, Eye, Calendar, MapPin, Users, DollarSign, Trash2 } from 'lucide-react';
...
export default function EventDetailPage() {
  ...
  const handleDeleteEvent = async () => {
    ...
    if (!confirm(`¿Estás seguro de que quieres eliminar el evento "${event.name}"? Esta acción no se puede deshacer.`)) {
      return;
    }
