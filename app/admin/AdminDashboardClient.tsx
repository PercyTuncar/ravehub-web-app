...
import { useAdminStats, TimeRange, CountryFilter } from "@/lib/hooks/useAdminStats";
import { DollarSign, Ticket, Users, Activity, Calendar, ArrowUpRight, TrendingUp, Music, ShoppingBag, Settings, FileText, CreditCard, ChevronDown, Globe } from "lucide-react";
...
import { StatCardSkeleton, ChartSkeleton, ActivitySkeleton } from '@/components/admin/StatCardSkeleton';
import {
  Select,
  SelectContent,
  SelectItem,
...
export default function AdminDashboardClient() {
  ...
  const { totalEvents, activeEvents, totalTickets, totalUsers, pendingPayments, totalRevenue, currency, currencySymbol, recentActivity, salesData, loading } = useAdminStats(timeRange, countryFilter);
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <Select value={countryFilter} onValueChange={(value: CountryFilter) => setCountryFilter(value)}>
          ...
          {loading ? (
            ...
            <>
              <StatCard
                ...
                value={formatPrice(totalRevenue / (totalTickets || 1), currency)}
                icon={DollarSign}
